<section class="section-padding" style="background-color:white;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-lext">
                        <?php if (isset($page_title) && $page_title == 'refund_policy'): ?>
                            <h3 class="title" style="background-image: url('<?php echo base_url() ?>assets/images/bgimage.png'); background-position: left top; height:150px;padding:50px; color:white; font-size:50px;margin-left:1em">Refund Policy</h3>
