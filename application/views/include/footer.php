...
<footer class="bg_gray">
    <div class="container-fluid">
        <div class="row border-bottom p-bot-5">
            <div class="col-md-6">
                <img src="<?php echo base_url($settings->logo) ?>" class="img-responsive logo_img" alt="">
            </div>
            <div class="col-md-6">
                    ...
                    <ul>
                        <li>
                          ...
                          <li>
                              ...
                              <li>
                                <a target="_blank" href="https://twitter.com/ektasitech">
                          ...
                          <li>
                            ...
                            <li>
                              <a target="_blank" href="https://www.linkedin.com/company/ektasi-technology/"
                                  title="linkedin">
                          ...
                          <li>
                            ...
                            <li>
                              <a target="_blank" href="https://www.instagram.com/ektasi.digital/" title="instagram">
