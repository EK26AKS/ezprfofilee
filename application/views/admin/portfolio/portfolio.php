          ...
          <div class="form-group">
              ...
              <div class="input-group">
                  <span class="input-group-btn">
                      ...
                      <!--img src="http://localhost/profileme/assets/front/images/avatar.png" alt="Dummy Image" /-->
                        <i class="fa fa-upload"></i>  Upload Image <input type="file" id="imgInp" name="photo">
                        <img class="profile-user-img rounded-circle img-fluid mx-auto d-block" src="http://localhost/profileme/assets/front/images/avatar.png" alt="User profile picture">
                      </span>
                  </span>
              </div><br>
