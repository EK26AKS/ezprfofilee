                ...
                <div class="col-md-12">
                    <div class="text-lext">
                        <?php if (isset($page_title) && $page_title == 'Terms & Condition'): ?>
                            <h3 class="title" style="background-image: url('<?php echo base_url() ?>assets/images/bgimage.png'); background-position: left top; height:150px;padding:50px; color:white; font-size:50px;">Terms & Conditions</h3>
