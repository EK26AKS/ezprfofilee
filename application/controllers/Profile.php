...
class Profile extends Home_Controller {
    ...
    {     
        ...
        if ($_POST) {
            ...
            $msg = 'Recently booked an appointment on'. $this->input->post('book_time');
    ...
    public function vcard($id='')
    {
        ...
        $vcard->addAddress($user->address, null, null, null, null, null, null);
        //$vcard->addAddress($user->address);
        $vcard->addLabel('');
        $vcard->addURL(base_url($user->slug));
