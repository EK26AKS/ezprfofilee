...
@section('content')
            ...
            <div class="experiance d-flex justify-content-center align-items-center ">
                <div class="experiance-content ">
                    ...
                    <div class="know-more">
                        <div class="aboutme-filter-button text-center">
                            <ul class="nav nav-pills align-items-center justify-content-center mb-3" id="pills-tab"
                                role="tablist">
                                ...
                                @foreach ($job_experiences as $job_experience)
                                    <div class="details-all">
                                        <div class="header-all">
                                            <h6>{{ $job_experience->designation }} [{{ $job_experience->company_name }}]
                                            </h6>
                ...
                <div class="experiance-img">
                    <div class="img-know-more">
                        <img src="{{ asset('assets/front/img/about-me.png') }}" class="logoimage" width="300"
                            alt="">
                    </div>
                </div>
            </div>
    ...
    <section class="tools" id="tools">
        ...
        <div class="container px-5" style="padding-top: 50px;">
            @foreach ($skills as $skill)
                <div class="mb-2">
                    <h3 class="text-center text-white">{{ $skill->title }}</h3>
                    <div class="progress">
    ...
    @if (is_array($userPermissions) && in_array('Service', $userPermissions))
        ...
        <section class="service-section section-gap bg-offwhite-color" id="service">
            <div class="tools-container1" style="text-align: center;">
                <span class="self-align-center">{{ $home_text->service_subtitle ?? __('What I Do ?') }}</span>
                <h4 class="self-align-center">{{ $home_text->service_title ?? __('Services') }}</h4>
            </div>

            {{-- <div class="row align-items-center justify-content-center">
                <div class="col-md-6">
                    <span class="text-center text-white fs-3">{{ $home_text->service_subtitle ?? __('What I Do ?') }}</span>
                </div>
            </div> --}}


            <div class="container p-3">
                <div class="row service-boxes align-items-center justify-content-center mt-2">
        ...
        <!--====== Service Section End ======-->
    @endif
    {{-- <h1 style="color:aliceblue;">Testimonial</h1> --}}
            ...
            <div class="contact">
                ...
                <div class="contact-container">
                    <div class="contact-header mb-5">
                        ...
                        <h4 class="align-self-center">{{ $home_text->contact_subtitle ?? __('Get in touch') }}</h4>
                    </div>
                    <div class="container">
                        <div class="contact-body">
                            <form action="{{ route('front.contact.message', [getParam()]) }}"
                                ...
                                <div class="row mb-2 justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="email"
                                            placeholder="{{ $keywords['Email_Address'] ?? 'Email_Address' }}"
                                            name="email">
                                        @if ($errors->has('email'))
                                ...
                                <div class="row mt-3 justify-content-center">
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="" rows="7" cols="5" name=""
                                            placeholder="{{ $keywords['Message..'] ?? 'Message..' }}" name="message"></textarea>
                                        @if ($errors->has('message'))
                                            <p class="text-danger mb-0">{{ $errors->first('message') }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="button-send text-center m-3">
