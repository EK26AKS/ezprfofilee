                    ...
                    <div class="col-lg-8 posts-list">
                        <div class="single-post row">
                            ...
                            <div class="col-lg-3  col-md-3">
                                <div class="blog_info text-right">
                                    ...
                                    <ul class="blog_meta list">
                                        ...
                                        <li><a href="#"><i
                                            class="fas fa-calendar-alt"></i><a>{{ \Carbon\Carbon::parse($blog->created_at)->format('F j, Y') }}</a><i class="lnr lnr-calendar-full"></i></a></li>
                            ...
                            <div class="col-lg-9 col-md-9 blog_details">
                                <img class="lazy" src="{{asset('assets/front/img/user/blogs/'.$blog->image)}}" alt="Blog Image" style="height:200px">
                                <h2 class="title mb-2"><a
                                ...
                                <p>{!! strlen(strip_tags($blog->content)) > 600 ? mb_substr(strip_tags($blog->content), 0, 600, 'utf-8') . '...' : strip_tags($blog->content) !!}</p>
                                {{-- <p>
